...
public class TelaChat {
  ...
  * Funcao: Cria um componente visual para cada mensagem, incluindo remetente, conteúdo e horário.
  ...
  * Funcao: Envia uma APDU de "LEAVE" para o servidor para que o usuário saia do grupo.
  * Parametros: String nomeGrupo - nome do grupo a ser deixado
  * Retorno: void
  *************************************************************** */
  private void enviarAPDULeave(String nomeGrupo) {
    try {
      app.getClienteTCP().enviarAPDULeave(app.getNomeUsuario(), nomeGrupo);
    } catch (Exception e) {
